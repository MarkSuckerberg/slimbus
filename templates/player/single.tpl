...
{% block content %}
	<h2>{{player.label|raw}}
		<small class="text-muted">
			|
			<a href="http://www.byond.com/members/{{player.ckey}}" target="_blank" rel="noopener noreferrer">
		...
		<div class="col">
			<ul class="list-group">
				...
				<li class="list-group-item">
					...
					<span class="tlp tlp-red">{{player.ip_real}}</span>
				</li>
				<li class="list-group-item">
					<strong>Last ComputerID</strong>
					<span class="tlp tlp-red">{{player.computerid}}</span>
				</li>
				<li class="list-group-item">
					<strong>Rounds</strong>
					{{player.roundCount}}
					(<a href="{{path_for('player.rounds',{'ckey': player.ckey})}}">List</a>)
				</li>
			</ul>
		</div>
		<div class="col">
						...
						{% for b in player.standing.bans %}
							<li>{{b.role}}
								(<a href="#">
									...
									{{b.id}}</a>) (
								{% if b.expiration_time %}Temp{% else %}Perma
								{% endif %})</li>
						{% endfor %}
					</ul>
				</li>
		...
		<div class="col">
			<ul class="list-group">
				...
				<li class="list-group-item">
					...
					~{{player.hours}}
					hours (<a href="{{path_for('player.roletime',{'ckey': player.ckey})}}">View Roles</a>)<br>
				...
				<li class="list-group-item">
					<strong>Byond Account Join Date</strong>
					{{player.accountjoindate}}
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col">
			<div class="card">
				<div class="card-header">
					<a data-target="#namelist" data-toggle="collapse">
				...
				<ul class="list-group list-group-flush collapse" id="namelist">
					{% if player.names.manifest %}
						...
						<p>
							<small class="text-muted">Times being the number of times this ckey was found attached to this character name in a parsed manifest.
								<strong>THIS IS PRELIMINARY</strong>
							</small>
						</p>
					{% endif %}
					...
					<p>
						<small class="text-muted">Times being the number of times this ckey has died while playing as this character name. Only the top five results are shown.
							<strong>THIS IS PRELIMINARY</strong>
						</small>
					</p>
				</ul>
	...
	<div class="row">
		<div class="col">
			<div class="card">
				<div class="card-header">
					<a data-target="#alts_ip" data-toggle="collapse">
						<span class="badge badge-info">BETA</span>
						Ckeys with the player's current IP address ({{player.alts.ip_alts|length}})</a>
				</div>
		...
		<div class="col">
			<div class="card">
				<div class="card-header">
					<a data-target="#alts_cid" data-toggle="collapse">
						<span class="badge badge-info">BETA</span>
						Ckeys with the player's current CID ({{player.alts.cid_alts|length}})</a>
				</div>
