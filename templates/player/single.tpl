  ...
  <div class="col">
    <div class="card">
      ...
      <ul class="list-group list-group-flush collapse" id="namelist">
        ...
        <p>
        <small class="text-muted">Times being the number of times this ckey was found attached to this character name in a parsed manifest. <strong>THIS IS PRELIMINARY</strong></small>
        </p>
        {% endif %}
