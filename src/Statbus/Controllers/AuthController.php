...
class AuthController extends Controller
{
  ...
  private $session_public_token;
  private $return_uri;
  private $AuthUrl;
  private $TokenUrl;
  private $AuthSessionUrl;
  ...
  public function auth_redirect($request, $response, $args)
  {
    $this->session_public_token = $_SESSION['session_public_token'];
    $this->session_private_token = $_SESSION['session_private_token'];

    return $response->withRedirect("$this->TokenUrl?session_public_token=" . urlencode($this->session_public_token));
  }
